...
void bluebucket::save()
{
	std::cout<<"Parameters saved\n";
        ifstream f("/home/devidutta/catkin_ws/src/tiburon_gui/config/bluebucketconfig.txt");
        if(f.eof())
	{
		std::cout<<"Config File missing\n";
                ofstream ofs("/home/devidutta/catkin_ws/src/tiburon_gui/config/bluebucketconfig.txt");
                ofs.close();
	}
        else
	{
		ofstream f("/home/devidutta/catkin_ws/src/tiburon_gui/config/bluebucketconfig.txt",ios::ate);
