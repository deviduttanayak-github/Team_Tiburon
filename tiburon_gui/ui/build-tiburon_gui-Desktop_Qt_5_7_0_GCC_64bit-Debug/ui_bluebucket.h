/********************************************************************************
** Form generated from reading UI file 'bluebucket.ui'
**
...
#ifndef UI_BLUEBUCKET_H
#define UI_BLUEBUCKET_H
...
public:
    ...
    {
        Gate_Detection->setWindowTitle(QApplication::translate("bluebucket", "Blue Bucket Tuner", 0));
        logo->setText(QString());
        TiburonLabel->setText(QApplication::translate("bluebucket", "Team Tiburon", 0));
        lineEdit_2->setText(QApplication::translate("bluebucket", "Gate Detection", 0));
    } // retranslateUi

};

namespace Ui {
    class bluebucket: public Ui_bluebucket {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_BLUEBUCKET_H
